const FALLBACK_BOSSES = [
  {
    ...
    phases: [
      ...
      { healthThreshold: 0.5, movementPattern: "chase", movementSpeed: 80, attackPattern: "gravity_pull", attackInterval: 2.0, attackParams: { radius: 150, strength: 100 } }
    ],
  ...
  },
  {
    ...
    phases: [
      ...
      { healthThreshold: 0.5, movementPattern: "zigzag", movementSpeed: 100, attackPattern: "shockwave", attackInterval: 1.5, attackParams: { radius: 120, speed: 160 } }
    ],
  ...
  },
  {
    ...
    phases: [
      { healthThreshold: 1.0, movementPattern: "figure_eight", movementSpeed: 45, attackPattern: "laser_sweep", attackInterval: 3.5, attackParams: { width: 4, sweepSpeed: 2.0 } },
  ...
  },
  {
    ...
    phases: [
      { healthThreshold: 1.0, movementPattern: "zigzag", movementSpeed: 80, attackPattern: "shockwave", attackInterval: 2.0, attackParams: { radius: 100, speed: 180 } },
    ...
    specialAbility: { type: "pull_vortex", cooldown: 5, description: "Creates a gravity well" },
