...
const MILESTONE_BOSSES = [
  {
    ...
    attackInterval: 3.0,
    attackParams: { count: 3, speed: 90, spread: 1.0 },
  ...
  },
  {
    ...
    attackInterval: 1.8,
    attackParams: { count: 2, speed: 160, spread: 0.3 },
  ...
  },
  {
    ...
    attackInterval: 0.6,
    attackParams: { speed: 110, radius: 4 },
  ...
  },
  {
    ...
    attackInterval: 2.0,
    attackParams: { burstCount: 4, burstSpeed: 130, laserWidth: 6, sweepSpeed: 1.8, vortexRadius: 160, vortexStrength: 120 },
  ...
  },
  {
    ...
    attackInterval: 1.5,
    attackParams: { headCount: 3, burstCount: 3, speed: 140, laserWidth: 4, sweepSpeed: 2.0 },
  ...
  },
  {
    ...
    attackInterval: 1.2,
    attackParams: { burstCount: 6, burstSpeed: 150, spiralSpeed: 120, minionCount: 3, minionSpeed: 110, shockwaveRadius: 180, shockwaveSpeed: 220 },
    movementPattern: 'figure_eight',
    movementSpeed: 60,
    size: 50,
    zoneLength: 4200,
...
const EASY_GUARDIANS = [
  {
    ...
    attackPattern: 'slow_burst',
    attackInterval: 3.0,
    attackParams: { count: 3, speed: 80, spread: 1.2 },
    movementPattern: 'hover_drift',
    movementSpeed: 25,
    size: 26,
    drawStyle: 'jelly',
  },
  {
    ...
    attackInterval: 2.8,
    attackParams: { count: 3, speed: 100, spread: 1.0 },
    movementPattern: 'hover_drift',
    movementSpeed: 30,
    size: 24,
    drawStyle: 'sprite',
  },
  {
    ...
    attackInterval: 3.5,
    attackParams: { radius: 120, speed: 150 },
    movementPattern: 'figure_eight',
    movementSpeed: 35,
    size: 30,
    drawStyle: 'moth',
  },
  {
    ...
    attackPattern: 'slow_burst',
    attackInterval: 3.2,
    attackParams: { count: 4, speed: 70, spread: 1.8 },
    movementPattern: 'orbit',
    movementSpeed: 30,
    size: 22,
    drawStyle: 'wisp',
...
const MEDIUM_GUARDIANS = [
  {
    ...
    attackPattern: 'projectile_burst',
    attackInterval: 2.0,
    attackParams: { count: 5, speed: 140, spread: 1.4 },
    movementPattern: 'hover_drift',
    movementSpeed: 40,
    size: 32,
    drawStyle: 'sentinel',
  },
  {
    ...
    attackInterval: 3.0,
    attackParams: { width: 5, sweepSpeed: 2.5 },
    movementPattern: 'zigzag',
    movementSpeed: 70,
    size: 36,
    drawStyle: 'sentinel',
  },
  {
    ...
    attackInterval: 4.0,
    attackParams: { radius: 180, strength: 110 },
    movementPattern: 'orbit',
    movementSpeed: 50,
    size: 38,
    drawStyle: 'sentinel',
  },
  {
    ...
    attackInterval: 2.5,
    attackParams: { count: 4, minionSpeed: 100 },
    movementPattern: 'patrol',
    movementSpeed: 60,
    size: 34,
    drawStyle: 'sentinel',
  },
  {
    ...
    attackPattern: 'shockwave',
    attackInterval: 2.0,
    attackParams: { radius: 140, speed: 200 },
    movementPattern: 'figure_eight',
    movementSpeed: 55,
    size: 30,
    drawStyle: 'sentinel',
...
const HARD_GUARDIANS = [
  {
    ...
    attackInterval: 2.2,
    attackParams: { width: 5, sweepSpeed: 3.0 },
    movementPattern: 'zigzag',
    movementSpeed: 80,
    size: 36,
    drawStyle: 'oracle',
  ...
  },
  {
    ...
    attackPattern: 'multi_attack',
    attackInterval: 2.5,
    attackParams: { burstCount: 5, burstSpeed: 120, laserWidth: 6, sweepSpeed: 2.0, vortexRadius: 150, vortexStrength: 100 },
    movementPattern: 'patrol',
    movementSpeed: 50,
    size: 44,
    drawStyle: 'colossus',
  },
  {
    ...
    attackInterval: 2.0,
    attackParams: { count: 3, speed: 100, homingStrength: 80 },
  ...
  },
  {
    ...
    attackInterval: 1.8,
    attackParams: { count: 4, speed: 150, spread: 1.2 },
    movementPattern: 'zigzag',
    movementSpeed: 90,
    size: 30,
    drawStyle: 'serpent',
  },
  {
    ...
    attackInterval: 2.5,
    attackParams: { ringCount: 8, speed: 160, shockwaveRadius: 160, shockwaveSpeed: 250 },
    movementPattern: 'figure_eight',
    movementSpeed: 40,
    size: 38,
    drawStyle: 'nova',
